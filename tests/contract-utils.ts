...
export function createBasicArenaLossEvent(
  _playerId: BigInt,
  _basicArenaId: BigInt
): BasicArenaLoss {
  let basicArenaLossEvent = changetype<BasicArenaLoss>(newMockEvent())

  basicArenaLossEvent.parameters = new Array()

  basicArenaLossEvent.parameters.push(
    new ethereum.EventParam(
      "_playerId",
  ...
  return basicArenaLossEvent
}

export function createBasicArenaWinEvent(
  _playerId: BigInt,
  _basicArenaId: BigInt
): BasicArenaWin {
  let basicArenaWinEvent = changetype<BasicArenaWin>(newMockEvent())

  basicArenaWinEvent.parameters = new Array()

  basicArenaWinEvent.parameters.push(
    new ethereum.EventParam(
      "_playerId",
      ethereum.Value.fromUnsignedBigInt(_playerId)
    )
  ...
  return basicArenaWinEvent
}

export function createCreateBasicArenaEvent(
  _basicArenaId: BigInt
): CreateBasicArena {
  let createBasicArenaEvent = changetype<CreateBasicArena>(newMockEvent())

  createBasicArenaEvent.parameters = new Array()

  createBasicArenaEvent.parameters.push(
    new ethereum.EventParam(
      "_basicArenaId",
      ethereum.Value.fromUnsignedBigInt(_basicArenaId)
    )
  ...
  return createBasicArenaEvent
}

export function createEnterBasicArenaEvent(
  _playerId: BigInt,
  _basicArenaId: BigInt
): EnterBasicArena {
  let enterBasicArenaEvent = changetype<EnterBasicArena>(newMockEvent())

  enterBasicArenaEvent.parameters = new Array()

  enterBasicArenaEvent.parameters.push(
    new ethereum.EventParam(
      "_playerId",
      ethereum.Value.fromUnsignedBigInt(_playerId)
    )
  ...
  return enterBasicArenaEvent
}

export function createLeaveBasicArenaEvent(
  _playerId: BigInt,
  _basicArenaId: BigInt
): LeaveBasicArena {
  let leaveBasicArenaEvent = changetype<LeaveBasicArena>(newMockEvent())

  leaveBasicArenaEvent.parameters = new Array()

  leaveBasicArenaEvent.parameters.push(
    new ethereum.EventParam(
      "_playerId",
      ethereum.Value.fromUnsignedBigInt(_playerId)
    )
...
export function createCreateBasicMonsterEvent(
  ...
  createBasicMonsterEvent.parameters.push(
    new ethereum.EventParam(
      "_basicMonster",
      ethereum.Value.fromTuple(_basicMonster)
    )
  )
